 ...
 * Tests login API endpoint for all roles
 */
...
$testUsers = [
    ...
    ['username' => 'member001', 'password' => 'password', 'role' => 'member'],
    ['username' => 'member002', 'password' => 'password', 'role' => 'member']
];

echo "=== Automated Login API Testing ===\n\n";
...
echo "If all tests pass, login system is working correctly!\n";
?>
