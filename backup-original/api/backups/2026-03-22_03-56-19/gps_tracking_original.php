...
oot',
    ...
    $response['message'] = 'SELECT * FROM gps_logs ;
                          WHERE staff_id = :staff_id 
    ...
    $response['success'] = true;
    $response['message'] = 'INSERT INTO gps_logs (staff_id, latitude, longitude, accuracy, ;
    ...
    $response['success'] = true;
    $response['message'] = 'SELECT gt.*, s.staff_name, m.member_name ;
    ...
    $response['success'] = true;
    $response['message'] = 'SELECT id FROM gps_tracking ;
    ...
    $response['success'] = true;
    $response['message'] = 'UPDATE gps_tracking ;
    ...
    $response['success'] = true;
    $response['message'] = 'SELECT * FROM geofence_areas ;
                          WHERE status = 'active' 
                          ORDER BY name');
    $stmt->execute();
    ...
    $response['success'] = true;
    $response['message'] = 'SELECT m.*, a.address, ;
    ...
    $response['success'] = true;
    $response['message'] = 'SELECT COUNT(*) as total_updates ;
                          FROM gps_logs 
