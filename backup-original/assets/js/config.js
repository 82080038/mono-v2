...
(function () {
    ...
    window.APP_CONFIG = {
        ...
        API: {
            AUTH: 'api/auth.php',
            AUTH_DEBUG: 'api/auth_debug.php',
            AUTH_SIMPLE: 'api/auth_simple.php',
            USERS: 'api/users.php',
    ...
    window.buildApiUrlWithFallback = function (endpoint, fallbackEndpoint) {
        try {
            return window.buildApiUrl(endpoint);
        } catch (e) {
            return window.buildUrl(fallbackEndpoint);
        }
    };
    ...
    if (window.APP_CONFIG.APP.DEBUG) {
        ...
        console.log('Sample URLs:', {
            ...
            api_debug: window.buildApiUrl('AUTH_DEBUG'),
            api_simple: window.buildApiUrl('AUTH_SIMPLE')
        });
    }
})();
